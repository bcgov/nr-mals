...
insert into mal_dairy_farm_test_job(id, job_status, job_source, execution_start_time, execution_end_time, source_row_count, target_insert_count, target_update_count, execution_comment)
