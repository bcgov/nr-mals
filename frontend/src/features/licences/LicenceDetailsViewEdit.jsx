...
export default function LicenceDetailsViewEdit({ licence }) {
  ...
  const initialFormValues = {
    ...
    reissueLicence: licence.data.reissueLicence,
  ...
  const [isReissueLicenceChecked, setIsReissueLicenceChecked] = React.useState(
    initialFormValues.reissueLicence,
  )
  ...
  const onLicenceDetailsCheckboxChange = (target, value) => {
    ...
    let reissueLicence = getValues('reissueLicence')
    ...
    switch (target) {
      ...
      case 'renewalNotice':
        ...
        break
      case 'reissueLicence':
        reissueLicence = value
        setIsReissueLicenceChecked(value)
        break
      default:
        break
    }
    ...
    <Form.Row>
      ...
      {licence &&
        ...
        licence.data.licenceTypeId === LICENCE_TYPE_ID_DAIRY_FARM && (
          <Col lg={3}>
            <Form.Group controlId="reissueLicence">
              <CustomCheckBox
                id="reissueLicence"
                label="Reissue Licence"
                defaultChecked={initialFormValues.reissueLicence}
                checked={isReissueLicenceChecked}
                onChange={(e) =>
                  onLicenceDetailsCheckboxChange(
                    'reissueLicence',
                    e.target.checked,
                  )
                }
